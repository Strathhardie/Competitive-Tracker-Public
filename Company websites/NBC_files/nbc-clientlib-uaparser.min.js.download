...
this.getUA=function(){return F
};
this.setUA=function(H){F=H;
return this
};
return this
};
...
if(typeof(exports)!==i){if(typeof module!==i&&module.exports){exports=module.exports=k
}exports.UAParser=k
}else{if(typeof(define)===t&&define.amd){define("ua-parser-js",[],function(){return k
})
}else{m.UAParser=k
}}var d=m.jQuery||m.Zepto;
if(typeof d!==i){var c=new k();
d.ua=c.getResult();
d.ua.get=function(){return c.getUA()
};
d.ua.set=function(E){c.setUA(E);
var D=c.getResult();
for(var F in D){d.ua[F]=D[F]
}}
